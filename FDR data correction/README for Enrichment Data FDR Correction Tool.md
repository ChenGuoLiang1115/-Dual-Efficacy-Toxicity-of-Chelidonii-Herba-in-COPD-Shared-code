...
Each processed dataset produces an Excel workbook with three sheets:
...
## Key Functionalities
- Intelligent p-value column detection accommodating naming variations  
...
The batch mode sequentially processes **BP**, **CC**, **MF**, and **KEGG** input files while maintaining a unified FDR threshold of `0.01` for all analyses.
